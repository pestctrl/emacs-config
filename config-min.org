...
#+begin_src emacs-lisp
  ...
  (when (member "Roboto Mono" (font-family-list))
    (set-face-attribute 'default nil :font "RobotoMono-10")
    (set-face-attribute 'fixed-pitch nil :font "RobotoMono-10"))

  (when (member "Liberation Serif" (font-family-list))
    (set-face-attribute 'variable-pitch nil :font "LiberationSerif-10"))
