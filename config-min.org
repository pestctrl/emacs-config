...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'default nil  :family "RobotoMono" :weight 'normal :height 100)
  (set-face-attribute 'fixed-pitch nil  :family "RobotoMono" :weight 'normal :height 100)
