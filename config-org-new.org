...
* Tag hierarchy
  #+begin_src emacs-lisp
    ...
    (setq org-agenda-hide-tags-regexp "time\\|nontime\\|prod\\|dev\\|sandbox\\|refile")
  #+end_src
* org-todo-keywords
  #+begin_src emacs-lisp
               ...
               ((tags-todo (concat ,dev-tag "&refile")
                ...
                (tags-todo (concat ,dev-tag "")
                           ((org-agenda-overriding-header "Stuck Projects")
                            ...
                            (org-tags-match-list-sublevels 'indented)))
                (tags-todo (concat ,dev-tag "-short")
                           ((org-agenda-overriding-header "Active Projects")
  ...
  #+begin_src emacs-lisp
    (setq org-capture-templates
          `(("t" "Todo" entry (file ,(my/agenda-file "refile.org"))
            ...
            ("c" "Record Comms Message" entry (file+olp+datetree ,(my/agenda-file "entries/datetree.org"))
             "* TODO %?")
            ("j" "Journal")
