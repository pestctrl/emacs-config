...
#+end_src
* org agenda delay till next week
#+begin_src emacs-lisp
  (defun my/org-delay-till-next-week ()
    (interactive)
    (org-agenda-schedule nil "sat")
    (next-line))

  (define-key org-agenda-mode-map (kbd "d") #'my/org-delay-till-next-week)
#+end_src
* Plan module
#+begin_src emacs-lisp
