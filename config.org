...
#+BEGIN_SRC emacs-lisp
  ...
  (defun lock-screen ()
    (interactive)
    (shell-command "i3lock-fancy & disown"))
...
#+begin_src emacs-lisp
  ...
  (define-key *multiple-cursors-map* (kbd " ") 'mc/vertical-align-with-space)
...
#+begin_src emacs-lisp
  ...
  current HH:MM of today at the selected date."
    (interactive)
    (let ((time (org-read-date t 'totime nil "Input freeze time: ")))
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'hydra-props-alist
               '(clementime-colume-hydra :verbosity 0))
#+end_src
* Broken
** Wunderlist
#+BEGIN_SRC emacs-lisp#
