...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        '(("t" "Todo" entry (file "~/MEGA/org/agenda/refile.org")
          ...
          ("p" "Protocol" entry (file+headline "~/MEGA/org/agenda/org-protocol.org" "Inbox")
           "* %^{Title}\nSource: %u, %c\n #+BEGIN_QUOTE\n%i\n#+END_QUOTE\n\n\n%?")
          ("L" "Protocol Link" entry (file+headline "~/MEGA/org/agenda/org-protocol.org" "Inbox")
           "* %? [[%:link][%:description]] \nCaptured On: %U")))
#+END_SRC
**** disabled 
#+BEGIN_SRC emacs-lisp#
     ...
     #+BEGIN_SRC emacs-lisp
       ...
       (setq org-agenda-custom-commands
             `(("p" "Project View"
               ...
               ;;   (tags-todo "+SCHEDULED<\"<today>\"/!TICKLER"
               ...
               ("lv" "Videos" tags-todo "VIDEO/!TODO")
               ("w" "Next week"
                ((tags-todo "-REFILE/!"
                            ((org-agenda-overriding-header "Stuck Projects")
                             (org-tags-match-list-sublevels 'indented)
