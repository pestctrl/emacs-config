(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/MEGA/org/entries/org-protocol.org" "~/MEGA/org/agenda/someday.org" "~/MEGA/org/agenda/learn.org" "~/MEGA/org/agenda/work.org" "~/MEGA/org/agenda/tech.org" "~/MEGA/org/agenda/school.org" "~/MEGA/org/agenda/refile.org" "~/MEGA/org/agenda/personal.org" "~/MEGA/org/agenda/people.org")))
 '(org-export-backends (quote (ascii beamer html icalendar latex)))
 '(org-super-agenda-mode t)
 '(org-trello-current-prefix-keybinding "C-c o")
 '(package-selected-packages
   (quote
    (w3m pulseaudio-control org-agenda all-the-icons-gnus arch-packer flop-frame elpy js2-mode pdf-tools clojure-mode paredit geiser magit ensime counsel-projectile helm-projectile projectile yasnippet irony elfeed org-caldav switch-window evil ivy company helm clj-refactor cider ac-cider overtone org-tree-slide tagedit web-mode langtool ledger-mode dmenu ocodo-svg-modelines skewer-mode inf-ruby restclient shell-pop org-toodledo dired-narrow dired+ org-wunderlist youtube-dl dired-aux elfeed-org calfw-ical mu4e org-protocol ox-reveal ob-clojure ob-core calfw-org org-habit epa-file ibuf-ext helm-config exwm-randr exwm-config exwm-systemtray glsl-mode oauth2 transpose-frame clojure-snippets common-lisp-snippets go-snippets haskell-snippets java-snippets yasnippet-bundle smex matlab-mode beacon company-flx dired-du diredful free-keys elfeed-goodies exwm-surf el-autoyas flycheck-clojure company-erlang company-ghc company-ghci company-go company-lua company-arduino company-c-headers company-cmake company-distel company-irony ac-c-headers ac-html ac-html-angular ac-slime ace-window exwm angular-mode smart-mode-line-powerline-theme ace-jump-mode ace-jump-buffer ace-jump-helm-line resize-window volume babel babel-repl lua-mode pocket-reader el-pocket magit-svn dirtree mu4e-alert habitica scala-mode auto-complete calfw calfw-gcal org-gcal nlinum nlinum-relative color-theme-modern linum-relative i3wm org-bullets windresize powerline-evil persistent-soft multi-term ergoemacs-mode epresent engine-mode)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#1c2124" :foreground "green" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "pyrs" :family "Roboto Mono"))))
