...
* Auto commit when saving org files
  #+begin_src emacs-lisp
        ...
        (let ((fname (expand-file-name f))
          ...
          (when (and (string-prefix-p org-agenda-git-repo-path
            ...
            (save-window-excursion 
              (when (not (string= (magit-get-current-branch)
                                  "master"))
    ...
    (advice-add #'save-buffer
                ...
                #'auto-commit-agenda)
  #+end_src
* modify org agenda follow mode
  #+begin_src emacs-lisp
    (defun my/org-agenda-show (&optional full-entry)
    ...
    (defun my/org-agenda-do-context-action ()
    ...
    (advice-add #'org-agenda-do-context-action
                :override
                #'my/org-agenda-do-context-action)
  #+end_src
